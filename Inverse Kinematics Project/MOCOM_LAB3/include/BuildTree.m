...
iTj(3,1,2) = 0; iTj(3,2,2) =-1; iTj(3,3,2) = 0; iTj(3,4,2) = 0.98;
...
iTj(2,1,4) = 0; iTj(2,2,4) = 1; iTj(2,3,4) = 0; iTj(2,4,4) = -0.1455;
iTj(3,1,4) =-1; iTj(3,2,4) = 0; iTj(3,3,4) = 0; iTj(3,4,4) = 0.3265;
iTj(4,1,4) = 0; iTj(4,2,4) = 0; iTj(4,3,4) = 0; iTj(4,4,4) = 1;

iTj(1,1,5) = 0; iTj(1,2,5) = 0; iTj(1,3,5) = 1; iTj(1,4,5) = 0.35;
...
iTj(3,1,6) =-1; iTj(3,2,6) = 0; iTj(3,3,6) = 0; iTj(3,4,6) = 0.385;
iTj(4,1,6) = 0; iTj(4,2,6) = 0; iTj(4,3,6) = 0; iTj(4,4,6) = 1;


iTj(1,1,7) = 0; iTj(1,2,7) = 0; iTj(1,3,7) =-1;  iTj(1,4,7) =-0.153;
